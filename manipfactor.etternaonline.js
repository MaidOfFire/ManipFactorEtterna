...
(function() {
    ...
    function calculateDeviations(keyAData, keyBData) {
        ...
        const lowerPercentileA = percentile(nonZeroDiffA, 10);
        const upperPercentileA = percentile(nonZeroDiffA, 50);

        const lowerPercentileB = percentile(nonZeroDiffB, 10);
        const upperPercentileB = percentile(nonZeroDiffB, 50);
